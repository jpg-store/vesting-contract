...
############################################################################
{ haskell-nix, gitignore-nix, compiler-nix-name, lib, libsodium-vrf }:
...
let
  project = haskell-nix.project {
    ...
    sha256map = {
      "https://github.com/input-output-hk/plutus-apps.git"."plutus-starter-devcontainer/v1.0.14" =
        "0j3hphj4b21vwdj900233d67qsaj91mppwsx1vv0ichnmnw2bmir";
      ...
      "https://github.com/input-output-hk/cardano-wallet"."d9563439e99d393380849f4586f7e2c9ab1e3561" =
        "0rm0y7fcr53fqd24ysd8mp74cxfgjxg6rhydq1njjnjmpknyswqm";
